...
import br.edu.fei.lite_zxing.result.ResultHandler;
import br.edu.fei.lite_zxing.result.TextResultHandler;
...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public static final String EXTRA_SCAN_CONTENT = "scan_content";
    ...
    private void handleDecodeInternally(Result rawResult) {
        ...
        resultIntent.putExtra(EXTRA_SCAN_CONTENT, rawResult.getText());
